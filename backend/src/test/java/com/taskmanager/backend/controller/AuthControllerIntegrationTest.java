...
class AuthControllerIntegrationTest {
    ...
    void register_returns400_whenPasswordTooShort() throws Exception {
        RegisterRequest request = new RegisterRequest("dave", "dave@example.com", "short");
    ...
    void login_returns401_whenPasswordIsWrong() throws Exception {
        ...
        LoginRequest login = new LoginRequest("frank@example.com", "wrongPassword");
    ...
    @Test
    void login_returns401_whenEmailDoesNotExist() throws Exception {
        LoginRequest login = new LoginRequest("ghost@example.com", "whatever1");
