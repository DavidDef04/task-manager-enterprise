  ...
  if (tasks.length === 0) {
    return (
      ...
      >
        ...
        <p className="text-sm font-medium text-slate-500">No tasks match your filters yet</p>
        <p className="text-xs text-slate-400">Create a task or adjust the filters above</p>
      </motion.div>
    );
  }
